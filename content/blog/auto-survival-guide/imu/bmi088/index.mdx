...
<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_33_57_bacffb40a03f401c8d456dd09b24f835.png" />
...
<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_34_10_e89725bc9d084d93abc631d5b2aa4912.png" />
...
<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_34_20_10bc01fee984460c84678a1f884e62fd.png" />

第四章开始，介绍了各个寄存器代表的意义和设置数值对应的结果，这一部分是读取的时候需要参考的，这里不再详细介绍

<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_34_31_e4ad09c6fa504f4e875ffdfaa0c0e66f.png" />

第五章开始，列出了 BMI088 的加速度计和陀螺仪的寄存器表，这也是读取的时候需要参考的部分，这里不过多讲解

<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_34_40_ce681335f2ae460682700cc621783b86.png" />

第六章开始，讲述了如何使用 SPI 或者 I2C 与 BMI088 进行数据通信，这一章比较重要，是我们读取的基础

<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_34_51_230bb88267ef48278c081aa75610b8de.png" />

第七章是 BMI088 的引脚图

<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_34_58_0a994cdea18f417ab1385beadc7acf16.png" />

第八章是 BMI088 的设计参考图，以及需要参考的电路设计参数

<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_35_7_e82f067510dc4139ae0062632eb7b723.png" />

第九章是免责声明

<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_35_13_c135362d7279407f8ca82d63d932c833.png" />

## 一、CubeMX 配置

由于这里是使用 RoboMaster 开发板 C 型（以下简称“C 板”），我们需要看用户手册确定 C 板上面的 IMU 是怎么设计的

<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_35_23_0358c812d83f4f448b1991a4e0ce9391.png" />
...
<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_35_27_307a95ec87bd443b8ee7b0cd54b3d9e4.png" />
...
<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_35_34_74bdc99635dd41a786d61e6c59e24052.png" />

这里的值的第一位是 bit7，也就是 MSB 端，所以可以断定我们的 First Bit 是 MSB first

然后就到了时钟配置的预分频系数 Prescaler 这里，这里注意到是要跟你 C 板的时钟配置相关联的，放出我的 C 板时钟配置

<img alt="image-20230118113902205" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_39_2_image-20230118113902205.png" />

其中，C 板（F406 芯片）的 SPI1 总线是挂载在 APB1 时钟上的，也就是说这个时候 SPI1 的初始时钟是 84MHz，我们再来看数据手册中关于 SPI 的时钟要求

<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_41_48_41c78cd88f32424eb03cc7b4fa731d1e.png" />
...
<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_41_55_2f8283434bf349d88a070d29204b6eb9.png" />
...
<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_42_1_cd3508bec777470fa48cce8a87dd4152.png" />
...
<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_42_7_d102f9c380634c3fb1a3ecc72ec22c98.png" />
...
<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_42_19_1b79849b3d6c4088b2d41fc959fb037c.png" />
...
<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_42_31_3139df502e234187a7ae3ed277fb2ef0.png" />
...
<img alt="请添加图片描述" src="https://git.nrs-lab.com/LiMinghang23m/picgo-pic/-/raw/main/pictures/2023/01/18_11_42_56_28860dd00ab9495e9bc89c8ea7b7674a.png" />

<Cards>
  <Card title="C194919_BMI088_2018-06-28.PDF" href="./C194919_BMI088_2018-06-28.PDF" />
</Cards>
